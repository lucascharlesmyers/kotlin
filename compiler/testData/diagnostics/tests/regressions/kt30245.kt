...
fun test1() { // to extension lambda 0
    ...
    val w13 = W1 { it } // oi- ni-
    val i13: E0 = id { it } // oi- ni-
    val j13 = id<E0> { it } // oi- ni-

    val o14 = W1 { -> 0 } // overload, oi- ni+
}
...
fun test2() { // to extension lambda 1
    ...
    val w26 = W2 { i, s -> i + s.length } // oi- ni-
    val i26: E1 = id { i, s -> i + s.length } // oi- ni-(EXPECTED_PARAMETERS_NUMBER_MISMATCH)
    val w27 = W2 { i, s: String -> i + s.length } // oi- ni-
    val i27: E1 = id { i, s: String -> i + s.length } // oi- ni-(EXPECTED_PARAMETERS_NUMBER_MISMATCH)
...
fun test3() { // to non-extension lambda 1
    ...
    val w32 = W3 { this } // oi- ni-
    val i32: L1 = id { this } // oi- ni-
    val j32 = id<L1> { this } // oi- ni-
    val w33 = W3(fun Int.(): Int = this) // oi- ni-
    val i33: L1 = id(fun Int.(): Int = this) // oi+ ni-(EXPECTED_PARAMETERS_NUMBER_MISMATCH)
...
fun test4() { // to non-extension lambda 2
    ...
    val w31 = W4 { this } // oi- ni-
    val i31: L2 = id { this } // oi- ni-(EXPECTED_PARAMETERS_NUMBER_MISMATCH)
    val w32 = W4 { this + it.length } // oi- ni-
    val i32: L2 = id { this + it.length } // oi- ni-(EXPECTED_PARAMETERS_NUMBER_MISMATCH)
}
